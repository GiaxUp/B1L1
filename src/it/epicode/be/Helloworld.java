...
public class Helloworld {
	...
	public static void main(String[] args) {
		...
		// Esercizio 2.3: Inserisci in un array una stringa in mezzo a delle altre
		// stringhe pre-esistenti
		int a[] = new int[5];
		a[0] = 10;
		...
		// Esercizio 3: Inserimento stringhe da console e stampa in ordine di
		// inserimento e in ordine di inserimento inverso
		...
		String concatenazioneInversa = stringa3 + stringa2 + stringa1; // Concatenazione delle stringhe in ordine
																		// inverso di inserimento
		System.out.println(
				"La concatenazione delle stringhe in ordine inverso di inserimento è: " + concatenazioneInversa);

		// Esercizio 4.1: perimetroRettangolo che accetta la lunghezza decimale dei due
		// lati di un rettangolo e ne calcola il perimetro
		double lato1 = 3.5;
		double lato2 = 5.2;
		double perimetro = perimetroRettangolo(lato1, lato2);
		System.out.println("Esercizio 4.1: " + "Il perimetro del rettangolo con lati " + lato1 + " e " + lato2 + " è "
				+ perimetro);
		// Esercizio 4.2: pariDispari che accetta un numero intero e restituisce 0 se il
		// numero è pari e 1 se è dispari
		int numeroPari = 6;
		int numeroDispari = 7;
		int risultato1 = pariDispari(numeroPari);
		int risultato2 = pariDispari(numeroDispari);
		System.out.println("Esercizio 4.2: " + numeroPari + " è pari? " + (risultato1 == 0)); // Se il numero è pari
																								// restituisce true
		System.out.println("Esercizio 4.2: " + numeroDispari + " è pari? " + (risultato2 == 0)); // Se il numero è
																									// dispari
																									// restituisce false
		// Esercizio 4.3: perimetroTriangolo che accetta le lunghezze decimali dei lati
		// di un triangolo e ne restituisca l'area (è possibile usare la formula di
		// Erone)
		...
		System.out.println("Esercizio 4.3: " + "L'area del triangolo con lati " + triangolo1 + ", " + triangolo2 + ", "
				+ triangolo3 + " è " + area);
	}
}
